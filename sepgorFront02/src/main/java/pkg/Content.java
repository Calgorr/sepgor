...
public class Content implements Serializable {
    public String publicKey = ""; //= Base64.getEncoder().encodeToString(keyPair.getPublicKey().getEncoded());//
    public String privateKey = "";//=Base64.getEncoder().encodeToString(keyPair.getPrivateKey().getEncoded()); //
    String serverKey = "";
    ...
    public void validKey2(Socket socket, InputClient inputClient){
        SeConMessage message = new SeConMessage(-1, Menu.tmpPublicKey);
        //System.out.println(message.getText());
        OutputClient outputClient = new OutputClient(socket, inputClient, message);
        outputClient.start();
    ...
    public void validSession(Socket socket, InputClient inputClient,String userName,String password) throws NoSuchAlgorithmException {
        ...
        Menu.tmpUsername = userName;
Menu.tmpPassword = password;
        if (!session.equals("")) {
